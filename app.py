...
st.set_page_config(page_title="PSX Institutional Intelligence Terminal", layout="wide", initial_sidebar_state="collapsed")
...
def render_terminal_sidebar() -> tuple[str, list[str], str]:
    ...
    # Android-native navigation support. The Android shell can open URLs such as
    # ?page=alerts, ?page=decision, ?page=scenario, ?page=divergence, ?page=portfolio.
    android_page_map = {
        "alerts": "1. Fast Up & Down Alert",
        "decision": "2. Decision Center",
        "scenario": "3. Scenario Finder",
        "divergence": "4. Divergence Finder",
        "portfolio": "5. Portfolio Checker",
    ...
    try:
        ...
        page_param = ""
    requested_page = android_page_map.get(page_param)
    if requested_page and st.session_state.get("_android_page_param") != page_param:
        st.session_state["simple_main_page"] = requested_page
        st.session_state["_android_page_param"] = page_param
